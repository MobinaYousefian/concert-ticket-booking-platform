...
import CtaSectionComponent from "@/app/(application)/activity/[id]/components/book-stats/cta-section/cta-section.component";
import ChangeShowingComponent from "@/app/(application)/activity/[id]/components/change-showing/change-showing.component";
