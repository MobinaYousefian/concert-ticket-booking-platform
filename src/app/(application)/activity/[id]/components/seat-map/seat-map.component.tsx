...
import PopoverProviderComponent from "@/app/(application)/activity/[id]/providers/popover/popover.provider";
import PopoverComponent from "@/app/(application)/activity/[id]/components/canvas/popover/popover.component";
...
const Canvas = dynamic(
  () =>
    import(
      "@/app/(application)/activity/[id]/components/canvas/canvas.component"
    ),
  {
    ssr: false,
    loading: () => (
