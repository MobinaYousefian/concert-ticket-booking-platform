...
import NoDataComponent from "@/app/(application)/search/components/no-data/no-data.component";

import { activityContext } from "@/app/(application)/search/providers/activity/activity.provider";
